...
import { flow, Predicate, Refinement } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/function.ts'
...
const imap_: Invariant2<URI>['imap'] = (ea, ab, ba) => lens(flow(ea.get, ab) as (s: never) => never, flow(ba, ea.set))
