...
import { Functor, Functor1, Functor2, Functor3 } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Functor.ts'
...
const imap_: Invariant2<URI>['imap'] = (ea, ab, ba) => iso(flow(ea.get, ab) as (s: never) => never, flow(ba, ea.reverseGet))
