...
import { getApplicative, make } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Const.ts'
import { Foldable, Foldable1, Foldable2, Foldable3 } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Foldable.ts'
import { constant, identity, Predicate, Refinement } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/function.ts'
import { HKT, Kind, Kind2, Kind3, URIS, URIS2, URIS3 } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/HKT.ts'
import { Monoid, monoidAll, monoidAny } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Monoid.ts'
import { fromNullable, fromPredicate, getFirstMonoid, isNone, Option, option, some } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Option.ts'
...
export class Optional<S, A> {
   ...
   * @example
   * import { Optional } from 'monocle-ts'
   * import * as O from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/Option'
   *
   * interface S {
   *   a: O.Option<number>
   * }
...
export class Traversal<S, A> {
   ...
   * import { Traversable } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/Array'
   *
   * interface Person {
   *   name: string;
   *   cool: boolean;
