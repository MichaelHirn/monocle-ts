 ...
 * @since 2.3.0
 */
import { Applicative, Applicative1, Applicative2, Applicative3 } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Applicative.ts'
...
import { Invariant2 } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Invariant.ts'
...
import { Traversable1 } from 'https://raw.githubusercontent.com/michaelhirn/fp-ts/master/lib/Traversable.ts'
...
const imap_: Invariant2<URI>['imap'] = (ea, ab, ba) => prism(flow(ea.getOption, O.map(ab)) as (s: never) => O.Option<never>, flow(ba, ea.reverseGet))
